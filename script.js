...
const api_url = "https://dfproject.herokuapp.com/user"
...
function loadData(records = []) {
	...
	for(let i=0; i<records.length; i++) {
		...
		table_data += `<td>${records[i].discussion}</td>`;
...
function postData() {
	...
	data = {name: name, category: category, discussion: discussion, email: email};
...
function putData() {
	...
	data = {_id: _id, name: name, category: category, discussion: discussion, email: email};
